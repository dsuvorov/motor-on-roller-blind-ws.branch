...
int ButtonPin = D1;               // Button pin for trigger fullup or fulldown or config during startup

// Setup Pin for motor driver
int MotorPin1 = D5;      
int MotorPin2 = D6;
int MotorPin3 = D7;
int MotorPin4 = D8;
...
Stepper_28BYJ_48 small_stepper(MotorPin1, MotorPin2, MotorPin3, MotorPin4); //Initiate stepper driver
